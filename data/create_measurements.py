...
def build_weather_station_name_list(dir):
    """
    Grabs the weather station names from example data provided in repo and dedups
    """
    station_names = []
    with open(f'{dir}/weather_stations.csv', 'r') as file:
...
def build_test_data(weather_station_names, num_rows_to_create, dir):
    """
    ...
    try:
        with open(f'{dir}/measurements.txt', 'w') as file:
    ...
    file_size = os.path.getsize(f"{dir}/measurements.txt")
...
def main():
    ...
    weather_station_names = build_weather_station_name_list(current_dir)
    print(estimate_file_size(weather_station_names, num_rows_to_create))
    build_test_data(weather_station_names, num_rows_to_create, current_dir)
